...
const categoriesLegend = createElement('legend', ['categories__title'], {}, 'Select a news category:');
...
['all', ...Object.keys(Categories).reverse()].forEach((categoryName) => {
    ...
    const radio = createElement('input', ['categories__radio'], { type: 'radio', name: 'categories', checked: 'true' });
    label.append(radio);
